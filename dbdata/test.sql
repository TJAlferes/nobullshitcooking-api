...
CREATE TABLE `nobsc_staff` (
  ...
  `avatar` varchar(255) NOT NULL DEFAULT 'nobsc-staff-default.png',
...
CREATE TABLE `nobsc_users` (
  ...
  `avatar` varchar(255) NOT NULL DEFAULT 'nobsc-user-default.png',
...
CREATE TABLE `nobsc_recipes` (
  ...
  `recipe_image` varchar(100) NOT NULL DEFAULT 'nobsc-recipe-default.png',
  `equipment_image` varchar(100) NOT NULL DEFAULT 'nobsc-recipe-equipment-default.png',
  `ingredients_image` varchar(100) NOT NULL DEFAULT 'nobsc-recipe-ingredients-default.png',
  `cooking_image` varchar(100) NOT NULL DEFAULT 'nobsc-recipe-cooking-default.png',
...
CREATE TABLE `nobsc_ingredients` (
  ...
  `ingredient_image` varchar(100) NOT NULL DEFAULT 'nobsc-ingredient-default.png',
...
CREATE TABLE `nobsc_equipment` (
  ...
  `equipment_image` varchar(100) NOT NULL DEFAULT 'nobsc-equipment-default.png',
