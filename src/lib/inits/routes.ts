...
import {
  staffRouter, userRouter,
  contentRouter, contentTypeRouter,
  cuisineRouter,
  dataInitRouter,
  equipmentRouter, equipmentTypeRouter,
  favoriteRecipeRouter,
  ingredientRouter, ingredientTypeRouter,
  measurementRouter,
  methodRouter,
  profileRouter,
  recipeRouter, recipeTypeRouter,
  searchRouter,
  supplierRouter
} from '../../routes';
