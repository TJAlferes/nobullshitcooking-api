...
const AWS_NOBSC_USER_INGREDIENTS_S3_BUCKET: string =
process.env.AWS_NOBSC_USER_INGREDIENTS_S3_BUCKET!;

export async function getSignedUrlIngredient(req: Request, res: Response) {
