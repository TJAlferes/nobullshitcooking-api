...
const AWS_NOBSC_USER_RECIPE_INGREDIENTS_S3_BUCKET = process.env.AWS_NOBSC_USER_RECIPE_INGREDIENTS_S3_BUCKET;
...
module.exports = async function(req, res) {
  ...
  const s3 = new AWS.S3({
    accessKeyId: process.env.AWS_NOBSC_USER_RECIPE_INGREDIENTS_ACCESS_KEY_ID,
  ...
  res.json({
    ...
    url: `https://${AWS_NOBSC_USER_RECIPE_INGREDIENTS_S3_BUCKET}.s3.amazonaws.com/${fileName}`
  });
};