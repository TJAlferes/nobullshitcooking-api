...
export function staffSupplierTests() {
  describe('POST /staff/supplier/create', () => {
    it('creates supplier', async () => {
      const { body } = await request(server).post('/staff/supplier/create').send({name: "Name"});
  ...
  describe('PUT /staff/supplier/update', () => {
    it('updates supplier', async () => {
      const { body } = await request(server).put('/staff/supplier/update').send({id: 88, name: "Name"});
  ...
  describe('DELETE /staff/supplier/delete', () => {
    it('deletes supplier', async () => {
      const { body } = await request(server).delete('/staff/supplier/delete').send({id: 88});
