...
export function staffContentTests() {
  describe('POST /staff/content/create', () => {
    it('creates content', async () => {
      const { body } = await request(server).post('/staff/content/create').send({contentTypeId: 4, published: null, title: "Title", items: []});
  ...
  describe('PUT /staff/content/update', () => {
    it('updates content', async () => {
      const { body } = await request(server).put('/staff/content/update').send({id: 88, contentTypeId: 4, published: null, title: "Title", items: []});
  ...
  describe('DELETE /staff/content/delete', () => {
    it('deletes content', async () => {
      const { body } = await request(server).delete('/staff/content/delete').send({id: 88});
