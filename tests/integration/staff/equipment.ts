...
export function staffEquipmentTests() {
  describe('POST /staff/equipment/create', () => {
    it('creates equipment', async () => {
      const { body } = await request(server).post('/staff/equipment/create').send({equipmentTypeId: 4, name: "Name", description: "Description.", image: "image"});
  ...
  describe('PUT /staff/equipment/update', () => {
    it('updates equipment', async () => {
      const { body } = await request(server).put('/staff/equipment/update').send({id: 88, equipmentTypeId: 4, name: "Name", description: "Description.", image: "image"});
  ...
  describe('DELETE /staff/equipment/delete', () => {
    it('deletes equipment', async () => {
      const { body } = await request(server).delete('/staff/equipment/delete').send({id: 88});
