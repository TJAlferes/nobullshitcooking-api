...
export function friendshipsTests(app: Express) {
  ...
  describe('POST /v1/users/:username/friendships/:friendname/create', () => {
    ...
    it('handles not found', async () => {
      const res = await agent
        .post('/v1/users/FakeUser1/friendships/NonExistingUser/create');
    ...
    it('handles blocked', async () => {
      await agent
        .post('/v1/users/FakeUser1/friendships/FakeUser2/block');
      const res = await agent
        .post('/v1/users/FakeUser1/friendships/FakeUser2/create');
      expect(res.status).toBe(403);
    });
  ...
  describe('DELETE /v1/users/:username/friendships/:friendname/reject', () => {
    it('handles success', async () => {
      await agent2.post('/v1/users/FakeUser2/friendships/FakeUser1/create');
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/FakeUser2/reject');
      expect(res.status).toBe(204);
    });

    it('handles not found', async () => {
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/NonExistingUser/reject');
      expect(res.status).toBe(404);
    });
  ...
  describe('DELETE /v1/users/:username/friendships/:friendname/delete', () => {
    it('handles success', async () => {
      ...
      await agent.patch('/v1/users/FakeUser1/friendships/FakeUser2/accept');
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/FakeUser2/delete');
      expect(res.status).toBe(204);
    });

    it('handles not found', async () => {
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/NonExistingUser/delete');
      expect(res.status).toBe(404);
    });
  ...
  describe('POST /v1/users/:username/friendships/:friendname/block', () => {
    ...
    it('handles not found', async () => {
      const res = await agent
        .post('/v1/users/FakeUser1/friendships/NonExistingUser/block')
        .set('X-CSRF-Token', csrfToken)
        .withCredentials(true);
      expect(res.status).toBe(404);
    });
  ...
  describe('DELETE /v1/users/:username/friendships/:friendname/unblock', () => {
    it('handles success', async () => {
      await agent
        ...
        .withCredentials(true);
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/FakeUser2/unblock')
        .set('X-CSRF-Token', csrfToken)
        .withCredentials(true);
      expect(res.status).toBe(204);
    });
    ...
    it('handles not found', async () => {
      const res = await agent
        .delete('/v1/users/FakeUser1/friendships/NonExistingUser/unblock');
      expect(res.status).toBe(404);
    });
